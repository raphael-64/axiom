...
export default function EditorLayout({
    ...
    }, [monacoInstance, theme, darkTheme, lightTheme]);
    ...
    return (
        <>
            <ManageAccessModal
                open={!!manageAccessId}
                setOpen={(open) =>
                    setManageAccessId(open ? manageAccessId : null)
                }
                ...
                <ResizablePanelGroup className="grow" direction="horizontal">
                    ...
                    >
                        <Explorer
                            ...
                            openAccess={(workspaceId) =>
                                setManageAccessId(workspaceId)
                            }
