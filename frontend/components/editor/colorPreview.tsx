...
export default function ColorPreview() {
  ...
  const [previewTheme, setPreviewTheme] = useState(resolvedTheme === "dark");
  ...
  return (
    <>
      ...
      >
        ...
        <p>
          a{" "}
          <span style={{ color: "#" + colorTheme?.rules[4].foreground }}>
            & !
          </span>
          a{" "}
          <span style={{ color: "#" + colorTheme?.rules[4].foreground }}>
          ...
          <span style={{ color: "#" + colorTheme?.rules[5].foreground }}>
            {" false"}
          </span>
        </p>
        <p>
          <span style={{ color: "#" + colorTheme?.rules[6].foreground }}>
            {"1) "}
          </span>
          a{" "}
          <span style={{ color: "#" + colorTheme?.rules[4].foreground }}>
        ...
        <p>
          ...
          <span style={{ color: "#" + colorTheme?.rules[2].foreground }}>
            {"by "}
          </span>
          <span style={{ color: "#" + colorTheme?.rules[3].foreground }}>
            {"contr"}
          </span>
          <span style={{ color: "#" + colorTheme?.rules[0].foreground }}>
            {"  // Comments"}
          </span>
        </p>
      </div>
